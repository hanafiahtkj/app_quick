            ...
            <div class="content-page">
                ...
                <div class="content">
                    ...
                    <div class="container-fluid">
                        ...
                        <?php
$sub_title = "Apps";$title = "Social Feed";
                        ...
                        <div class="row">
                            ...
                            <div class="col-xl-6 col-lg-12 order-lg-2 order-xl-1">
                                    ...
                                    <div class="card-body">
                                        <div class="d-flex align-items-start">
                                            ...
                                            <div class="w-100">
                                                ...
                                                <h5 class="m-0"><a href="contacts-profile.php" class="text-reset">Jeremy Tomlinson</a></h5>
                                ...
                                <div class="card">
                                    <div class="card-body">
                                        <div class="d-flex align-items-start">
                                            <img class="me-2 avatar-sm rounded-circle" src="assets/images/users/user-4.jpg"
                                                alt="Generic placeholder image">
                                            <div class="w-100">
                                                <div class="dropdown float-end text-muted">
                                                    <a href="#" class="dropdown-toggle text-muted font-18" data-bs-toggle="dropdown" aria-expanded="false">
                                                ...
                                                <h5 class="m-0"><a href="contacts-profile.php" class="text-reset">Thelma Fridley</a></h5>
                                            ...
                                            <div class="d-flex align-items-start">
                                                ...
                                                <div class="w-100">
                                                    ...
                                                    <div class="d-flex align-items-start mt-3">
                                                        ...
                                                        <div class="w-100">
                                                            <h5 class="mt-0"><a href="contacts-profile.php" class="text-reset">Kathleen Thomas</a> <small class="text-muted">5 hours ago</small></h5>
                                    ...
                                    <div class="card-body">
                                        <div class="d-flex align-items-start">
                                            ...
                                            <div class="w-100">
                                                ...
                                                <h5 class="m-0"><a href="contacts-profile.php" class="text-reset">Jonathan Tiner</a></h5>
