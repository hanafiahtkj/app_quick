            ...
            <div class="content-page">
                ...
                <div class="content">
                    ...
                    <div class="container-fluid">
                        ...
                        <?php
$sub_title = "Extended UI";$title = "Dragula";
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                <div id="company-list-left" class="py-2">
                                                    ...
                                                    <div class="card border rounded">
                                                        <div class="card-body">
                                                            <div class="d-flex align-itames-start">
                                                                <img src="assets/images/users/user-3.jpg" alt="image" class="me-3 d-none d-sm-block avatar-sm rounded-circle">
                                                                <div class="w-100">
                                                ...
                                                <div id="company-list-right" class="py-2">
                                                    <div class="card border rounded">
                                                        <div class="card-body p-3">
                                                            <div class="d-flex align-itames-start">
                                                                <img src="assets/images/users/user-4.jpg" alt="image" class="me-3 d-none d-sm-block avatar-sm rounded-circle">
                                                                <div class="w-100">
                                                    ...
                                                    <div class="card border rounded">
                                                        <div class="card-body p-3">
                                                            <div class="d-flex align-itames-start">
                                                                <img src="assets/images/users/user-5.jpg" alt="image" class="me-3 d-none d-sm-block avatar-sm rounded-circle">
                                                                <div class="w-100">
                                                    ...
                                                    <div class="card border rounded">
                                                        <div class="card-body p-3">
                                                            <div class="d-flex align-itames-start">
                                                                <img src="assets/images/users/user-6.jpg" alt="image" class="me-3 d-none d-sm-block avatar-sm rounded-circle">
                                                                <div class="w-100">
                                                ...
                                                <div class="bg-light p-2 p-lg-4">
                                                    ...
                                                    <div id="handle-dragula-left" class="py-2">
                                                        ...
                                                        <div class="card mb-0 mt-2">
                                                            <div class="card-body">
                                                                <div class="d-flex align-itames-start">
                                                                    <img src="assets/images/users/user-7.jpg" alt="image" class="me-3 d-none d-sm-block avatar-sm rounded-circle">
                                                                    <div class="w-100">
                                                        ...
                                                        <div class="card mb-0 mt-2">
                                                            <div class="card-body">
                                                                <div class="d-flex align-itames-start">
                                                                    <img src="assets/images/users/user-8.jpg" alt="image" class="me-3 d-none d-sm-block avatar-sm rounded-circle">
                                                                    <div class="w-100">
                                                        ...
                                                        <div class="card mb-0 mt-2">
                                                            <div class="card-body">
                                                                <div class="d-flex align-itames-start">
                                                                    <img src="assets/images/users/user-9.jpg" alt="image" class="me-3 d-none d-sm-block avatar-sm rounded-circle">
                                                                    <div class="w-100">
                                                ...
                                                <div class="bg-light p-2 p-lg-4">
                                                    ...
                                                    <div id="handle-dragula-right" class="py-2">
                                                        <div class="card mb-0 mt-2">
                                                            ...
                                                            <div class="card-body p-3">
                                                                <div class="d-flex align-itames-start">
                                                                    <img src="assets/images/users/user-10.jpg" alt="image" class="me-3 d-none d-sm-block avatar-sm rounded-circle">
                                                                    <div class="w-100">
