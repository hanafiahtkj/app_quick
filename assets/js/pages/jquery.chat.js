!(function (s) {
  ...
  function t() {
    (this.$body = s("body")),
      (this.$chatInput = s(".chat-input")),
      (this.$chatList = s(".conversation-list")),
      (this.$chatSendBtn = s(".chat-send")),
      (this.$chatForm = s("#chat-form"));
  }
  (t.prototype.save = function () {
    ...
    return "" == t
      ...
      : (s(
          '<li class="clearfix odd"><div class="chat-avatar"><img src="../assets/images/users/user-2.jpg" alt="male"><i>' +
            i +
