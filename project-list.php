            ...
            <div class="content-page">
                ...
                <div class="content">
                    ...
                    <div class="container-fluid">
                        ...
                        <?php
$sub_title = "Projects";$title = "Projects List";
include 'partials/page-title.php'; ?>

                        <div class="row mb-2">
                            <div class="col-sm-4">
                                <a href="project-create.php" class="btn btn-danger rounded-pill waves-effect waves-light mb-3"><i class="mdi mdi-plus"></i> Create Project</a>
                            </div>
                            <div class="col-sm-8">
                                ...
                                <div class="card project-box">
                                    <div class="card-body">
                                        ...
                                        <div class="avatar-group mb-3" id="tooltips-container2">
                                            <a href="javascript: void(0);" class="avatar-group-item">
                                                <img src="assets/images/users/user-9.jpg" class="rounded-circle avatar-sm" alt="friend" data-bs-container="#tooltips-container2" data-bs-toggle="tooltip" data-bs-placement="bottom" title="Mat Helme" />
                                            </a>
    
                                            <a href="javascript: void(0);" class="avatar-group-item">
                                                <img src="assets/images/users/user-10.jpg" class="rounded-circle avatar-sm" alt="friend" data-bs-container="#tooltips-container2" data-bs-toggle="tooltip" data-bs-placement="bottom" title="Michael Zenaty" />
                                            </a>
                                            ...
                                            <a href="javascript: void(0);" class="avatar-group-item">
                                                <img src="assets/images/users/user-3.jpg" class="rounded-circle avatar-sm" alt="friend" data-bs-container="#tooltips-container2" data-bs-toggle="tooltip" data-bs-placement="bottom" title="Mat Helme" />
                                            </a>
                                        </div>
                                        <!-- Progress-->
                                ...
                                <div class="card project-box">
                                    <div class="card-body">
                                        ...
                                        <div class="avatar-group mb-3" id="tooltips-container3">
                                            <a href="javascript: void(0);" class="avatar-group-item">
                                                <img src="assets/images/users/user-5.jpg" class="rounded-circle avatar-sm" alt="friend" data-bs-container="#tooltips-container3" data-bs-toggle="tooltip" data-bs-placement="bottom" title="Mat Helme" />
                                            </a>
    
                                            <a href="javascript: void(0);" class="avatar-group-item">
                                                <img src="assets/images/users/user-8.jpg" class="rounded-circle avatar-sm" alt="friend" data-bs-container="#tooltips-container3" data-bs-toggle="tooltip" data-bs-placement="bottom" title="Michael Zenaty" />
                                            </a>
    
                                            <a href="javascript: void(0);" class="avatar-group-item">
                                                <img src="assets/images/users/user-9.jpg" class="rounded-circle avatar-sm" alt="friend" data-bs-container="#tooltips-container3" data-bs-toggle="tooltip" data-bs-placement="bottom" title="James Anderson" />
                                            </a>
                                        </div>
                                        <!-- Progress-->
                                ...
                                <div class="card project-box">
                                    <div class="card-body">
                                        ...
                                        <div class="avatar-group mb-3" id="tooltips-container4">
                                            <a href="javascript: void(0);" class="avatar-group-item">
                                                <img src="assets/images/users/user-3.jpg" class="rounded-circle avatar-sm" alt="friend" data-bs-container="#tooltips-container4" data-bs-toggle="tooltip" data-bs-placement="bottom" title="James Anderson" />
                                            </a>
    
                                            <a href="javascript: void(0);" class="avatar-group-item">
                                                <img src="assets/images/users/user-4.jpg" class="rounded-circle avatar-sm" alt="friend" data-bs-container="#tooltips-container4" data-bs-toggle="tooltip" data-bs-placement="bottom" title="Mat Helme" />
                                            </a>
    
                                            <a href="javascript: void(0);" class="avatar-group-item">
                                                <img src="assets/images/users/user-5.jpg" class="rounded-circle avatar-sm" alt="friend" data-bs-container="#tooltips-container4" data-bs-toggle="tooltip" data-bs-placement="bottom" title="Username" />
                                            </a>
                                ...
                                <div class="card project-box">
                                    <div class="card-body">
                                        ...
                                        <div class="avatar-group mb-3" id="tooltips-container5">
                                            <a href="javascript: void(0);" class="avatar-group-item">
                                                <img src="assets/images/users/user-6.jpg" class="rounded-circle avatar-sm" alt="friend" data-bs-container="#tooltips-container5" data-bs-toggle="tooltip" data-bs-placement="bottom" title="Mat Helme" />
                                            </a>
    
                                            <a href="javascript: void(0);" class="avatar-group-item">
                                                <img src="assets/images/users/user-7.jpg" class="rounded-circle avatar-sm" alt="friend" data-bs-container="#tooltips-container5" data-bs-toggle="tooltip" data-bs-placement="bottom" title="Michael Zenaty" />
                                            </a>
    
                                            <a href="javascript: void(0);" class="avatar-group-item">
                                                <img src="assets/images/users/user-8.jpg" class="rounded-circle avatar-sm" alt="friend" data-bs-container="#tooltips-container5" data-bs-toggle="tooltip" data-bs-placement="bottom" title="James Anderson" />
                                            </a>
                                        </div>
                                        <!-- Progress-->
