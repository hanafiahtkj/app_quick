            ...
            <div class="content-page">
                ...
                <div class="content">
                    ...
                    <div class="container-fluid">
                        ...
                        <?php
$sub_title = "Tickets";$title = "Ticket Detail";
                            ...
                            <div class="col-xl-8 col-lg-7">
                                ...
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <div class="d-flex align-items-start">
                                            <img class="me-2 rounded-circle" src="assets/images/users/user-9.jpg"
                                        ...
                                        <div class="d-flex align-items-start mt-3">
                                            <img class="me-2 rounded-circle" src="assets/images/users/user-2.jpg"
                                                alt="Generic placeholder image" height="32">
                                            <div class="w-100">
