                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-6">
                                            <div class="text-end">
                                                ...
                                                <p class="text-muted mb-1 text-truncate">Total TPS</p>
                                            </div>
                                        </div>
                                    </div> <!-- end row-->
                                </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-6">
                                            <div class="text-end">
                                                ...
                                                <p class="text-muted mb-1 text-truncate">Total Saksi</p>
                                            </div>
                                        </div>
                                    </div> <!-- end row-->
                                </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-6">
                                            <div class="text-end">
                                                ...
                                                <p class="text-muted mb-1 text-truncate">Total DPT</p>
                                            </div>
                                        </div>
                                    </div> <!-- end row-->
                                </div>
                        ...
                        <div class="col-xl-6">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <h4 class="header-title mb-3">Status Selesai</h4>
                        ...
                        <div class="col-xl-6">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <h4 class="header-title mb-3">Status Belum Selesai</h4>
