            ...
            <div class="content-page">
                ...
                <div class="content">
                    ...
                    <div class="container-fluid">
                        ...
                        <?php
$sub_title = "Ecommerce";$title = "Checkout";
                                        ...
                                        <div class="row">
                                            <div class="col-lg-4">
                                                <div class="nav nav-pills flex-column navtab-bg nav-pills-tab text-center" id="v-pills-tab" role="tablist" aria-orientation="vertical">
                                                    <a class="nav-link active show py-2" id="custom-v-pills-billing-tab" data-bs-toggle="pill" href="#custom-v-pills-billing" role="tab" aria-controls="custom-v-pills-billing"
                                                        aria-selected="true">
                                                        <i class="mdi mdi-account-circle d-block font-24"></i>
                                                        Billing Info
                                                    </a>
                                                    <a class="nav-link mt-2 py-2" id="custom-v-pills-shipping-tab" data-bs-toggle="pill" href="#custom-v-pills-shipping" role="tab" aria-controls="custom-v-pills-shipping"
                                                        aria-selected="false">
                                                        <i class="mdi mdi-truck-fast d-block font-24"></i>
                                                        Shipping Info</a>
                                                    <a class="nav-link mt-2 py-2" id="custom-v-pills-payment-tab" data-bs-toggle="pill" href="#custom-v-pills-payment" role="tab" aria-controls="custom-v-pills-payment"
                                                        aria-selected="false">
                                                        ...
                                                        <table class="table table-centered table-nowrap mb-0">
                                                            <tbody>
                                                                <tr>
                                                                    ...
                                                                    <td>
                                                                        <a href="ecommerce-product-detail.html" class="text-body fw-semibold">Polo Navy blue T-shirt</a>
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td>
                                                                        <a href="ecommerce-product-detail.html" class="text-body fw-semibold">Red Hoodie for men</a>
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td>
                                                                        <a href="ecommerce-product-detail.html" class="text-body fw-semibold">Designer Awesome T-Shirt</a>
