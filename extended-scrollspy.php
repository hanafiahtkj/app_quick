            ...
            <div class="content-page">
                ...
                <div class="content">
                    ...
                    <div class="container-fluid">
                        ...
                        <?php
$sub_title = "Extended UI";$title = "Scrollspy";
                                        ...
                                        <nav id="navbar-example2" class="navbar navbar-light bg-light px-3">
                                            ...
                                            <ul class="nav nav-pills">
                                                ...
                                                <li class="nav-item dropdown">
                                                    <a class="nav-link dropdown-toggle arrow-none" data-bs-toggle="dropdown" href="#" role="button" aria-haspopup="true"
                                                        aria-expanded="false">Dropdown <i class="mdi mdi-chevron-down"></i></a>
